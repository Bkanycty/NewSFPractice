...
class editable_wheel(Command):
    ...
    def _select_strategy(
        ...
        if set(self.package_dir) == {""} and has_simple_layout or is_compat_mode:
            # images-layout(ish) is relatively safe for a simple pth file
...
def _simple_layout(
    ...
    >>> _simple_layout(['a'], {"": "images"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {"": "images"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"": "images"}, "/tmp/myproj")
    True
    ...
    False
    >>> _simple_layout(['a', 'a.b'], {"": "images", "a.b": "_ab"}, "/tmp/myproj")
    False
    >>> # Special cases, no packages yet:
    >>> _simple_layout([], {"": "images"}, "/tmp/myproj")
    True
    >>> _simple_layout([], {"a": "_a", "": "images"}, "/tmp/myproj")
    False
    """
    layout = {
...
def _parent_path(pkg, pkg_path):
    ...
    own path.
    >>> _parent_path("a", "images/a")
    'images'
    >>> _parent_path("b", "images/c")
    'images/c'
    """
